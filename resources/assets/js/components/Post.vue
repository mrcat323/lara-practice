    ...
    <div class="post-view" v-if="!error">
      <div class="container">
        <div class="blog-post">
          ...
          <p class="blog-post-meta">{{ post.created_at }} by <a href="#">Mark</a> <router-link class="btn btn-success" :to="{ name: 'post-edit', params: {id: post.id} }"><i class="fa fa-pencil-alt"></i></router-link></p>
